...
//        BufferedWriter bufferedWriter = null;
        ...
        readFile(args[0],departmentsMap,employees);
        writeFile(args[1],departmentsMap,employees);


    }

    public static void readFile(String str, Map<String,Department> departmentsMap, ArrayList<Employee> employees){
